...
print (type(data),'x 2:', data * 2) # This outputs the list twice 
print('---')
print (type(grades),'x 2:', grades * 2) # Numpy array however multiplies each element by 2
...
# {:.2f} means format two decimal places
